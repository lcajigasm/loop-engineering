---
description: Resume the project exactly where it was left; pick and run the next eligible loop.
---
Run the loop-engineering `auto` command.

Follow the canonical spec's `auto` section exactly, including the Codex
